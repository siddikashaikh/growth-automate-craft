...
const HeroSection = () => {
  ...
  return <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="absolute inset-0 opacity-20">
        ...
        <div className="absolute bottom-20 right-10 w-48 h-48 bg-secondary/20 rounded-full blur-xl floating" style={{
        animationDelay: '2s'
      }}></div>
        <div className="absolute top-1/2 left-1/3 w-24 h-24 bg-primary/30 rounded-full blur-lg floating" style={{
        animationDelay: '4s'
      }}></div>
      </div>
      ...
      <div className="container mx-auto px-6 grid lg:grid-cols-2 gap-12 items-center relative z-10">
        ...
        <div className="space-y-8 fade-in-up">
          <div className="space-y-4">
            <h1 className="text-5xl lg:text-7xl font-bold leading-tight">
              ...
              {typingComplete && <span className="block gradient-text-secondary fade-in-up delay-100 text-2xl">
          ...
          <div className="flex flex-col sm:flex-row gap-4 fade-in-up delay-400">
            <a href="https://calendly.com/softwelve/30min" target="_blank" rel="noopener noreferrer" className="btn-hero inline-flex items-center justify-center gap-2">
              Get Your Custom Scaling Plan
              <ArrowRight className="w-5 h-5" />
            </a>
            
            <Button variant="outline" size="lg" className="glass-card border-primary/30 text-primary hover:bg-primary/10" onClick={() => scrollToSection('demo')}>
        ...
        <div className="relative fade-in-up delay-300">
          <div className="relative">
            <img src={heroImage} alt="AI Dashboard showing automated business operations" className="w-full h-auto rounded-2xl glow" />
            ...
            <div className="absolute -bottom-4 -left-4 glass-card p-4 floating" style={{
            animationDelay: '1s'
          }}>
